...
// Check if the user is logged in by verifying the session name and email
...
// Fetch the single closest upcoming booking
...
// Combine greeting with the captured name
...
<body>
    ...
    <div class="phone-container">
        ...
        <div class="action-grid">
            <a href="admin_rules.php" style="text-decoration: none;">
                <div class="card blue">
            ...
            <a href="admin_bookings.php" style="text-decoration: none;">
